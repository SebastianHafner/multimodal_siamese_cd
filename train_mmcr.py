...
def run_training(cfg):
    ...
    for epoch in range(1, epochs + 1):
        ...
        evaluation.model_evaluation_mm_dt(net, cfg, 'train', epoch_float, global_step)
        evaluation.model_evaluation_mm_dt(net, cfg, 'val', epoch_float, global_step)
        evaluation.model_evaluation_mm_dt(net, cfg, 'test', epoch_float, global_step)
