...
def run_training(cfg: experiment_manager.CfgNode, sthlm_data_path: str):
    ...
    dataset = datasets.StockholmCDDataset(cfg=cfg, run_type='train', sthlm_data_path=sthlm_data_path)
    print(dataset)
...
if __name__ == '__main__':
    args = parsers.stockholm_argument_parser().parse_known_args()[0]
    ...
    try:
        run_training(cfg, args.sthlm_dir)
